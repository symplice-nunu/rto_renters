...
class _EditCancelScreenState extends State<EditPersonScreen> {
  ...
  Future<void> _saveForm() async {
    ...
    if (_editedCancel.id != null) {
      ...
      try {
        await Provider.of<Houses>(context, listen: false)
            .addPersonDetails(_editedCancel);
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    TextFormField(
                     ...
                     validator: (value) {
                        if (value.isEmpty) {
                          return 'Please provide Job Title.';
                        }
                        return null;
                      },
                      onSaved: (value) {
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (value.length < 5) {
                          return 'Should be at least in hundreds k.';
                        }
                        return null;
                      },
                      onSaved: (value) {
